...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "OJEX OIL ANG GAS SERVICES" },
      { property: "og:title", content: "OJEX OIL ANG GAS SERVICES" },
      { name: "twitter:title", content: "OJEX OIL ANG GAS SERVICES" },
      { name: "description", content: "Trusted partner for industrial sourcing, equipment supply, base oil distribution, and oilfield manpower across West Africa." },
      { property: "og:description", content: "Trusted partner for industrial sourcing, equipment supply, base oil distribution, and oilfield manpower across West Africa." },
      { name: "twitter:description", content: "Trusted partner for industrial sourcing, equipment supply, base oil distribution, and oilfield manpower across West Africa." },
