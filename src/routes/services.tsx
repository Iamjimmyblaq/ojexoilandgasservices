              ...
              <div key={link.to} className="card-elevated group flex flex-col overflow-hidden p-0">
                ...
                <div className="mt-5 flex flex-wrap items-center gap-3 pt-2">
                  <Link
                    ...
                    className="ml-6 inline-flex items-center gap-1.5 rounded-md bg-[color:var(--gold)] px-3 py-1.5 text-xs font-semibold uppercase tracking-wider text-[color:var(--navy-deep)] transition-colors hover:bg-[color:var(--gold-deep)] hover:text-white"
                  >
